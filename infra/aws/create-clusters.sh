...
create_cluster() {
  ...
  ecs-cli up --force --instance-role ecsInstanceRole --size 1 --instance-type $1 --no-associate-public-ip-address --cluster-config $2 --ecs-profile $3 --vpc $VPC_ID --subnets $SUBNET_1_ID,$SUBNET_2_ID --security-group $SECURITY_GROUP
}
